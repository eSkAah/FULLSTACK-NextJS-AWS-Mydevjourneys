                            ...
                            <div className="col-xl-10 col-lg-12">
                                ...
                                <div className="row">
                                    <div className="col-lg-8">
                                        ...
                                        <div className="box-tags wow animate__animated animate__fadeIn"><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 hover-up" href="blog-archive.html">#Nature</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 hover-up" href="blog-archive.html">#Beauty</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 hover-up" href="blog-archive.html">#Travel Tips</a><a className="btn btn-tags bg-gray-850 border-gray-800 hover-up" href="blog-archive.html">#House</a></div>
                                    </div>
                                        ...
                                        <div className="sidebar">
                                                ...
                                                <div className="content-sidebar">
                                                    <div className="list-comments">
                                                        ...
                                                        <div className="item-comment border-gray-800 wow animate__animated animate__fadeIn">
                                                            ...
                                                            <p className="color-gray-500"><a className="text-white" href="#">www.orioncoporation.com</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="d-inline-block pt-10 wow animate__animated animate__fadeIn">
                                                <div className="d-flex align-item-center">
                                                    <h6 className="d-inline-block color-gray-500 mr-10">Share</h6><a className="icon-media icon-fb" href="#" /><a className="icon-media icon-tw" href="#" /><a className="icon-media icon-printest" href="#" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
